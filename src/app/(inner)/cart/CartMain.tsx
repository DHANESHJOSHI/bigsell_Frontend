...
const CartMain = () => {
  const { cartItems, removeFromCart, updateItemQuantity, isCartLoaded } =
    useCart();
  ...
  const clearCart = () => {
    ...
    setCouponMessage("");
    const safeCartItems = Array.isArray(cartItems) ? cartItems : [];
    safeCartItems.forEach((item) => removeFromCart(item.id));
  };
          ...
          <div className="col-xl-9 col-12 order-2 order-xl-1">
            <div className="cart-area-main-wrapper">
              <div className="cart-top-area-note">
                <p>
                  Add <span>₹ 5000</span> to cart and get free shipping
                </p>
